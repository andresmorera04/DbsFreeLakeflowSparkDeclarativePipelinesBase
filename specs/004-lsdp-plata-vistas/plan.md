...
**Almacenamiento**: Unity Catalog Managed Tables — las vistas materializadas de plata se crean directamente en `plata.regional` via LSDP. No requieren rutas de archivos.
