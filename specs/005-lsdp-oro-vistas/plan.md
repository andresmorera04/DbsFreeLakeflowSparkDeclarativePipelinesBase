...
**Almacenamiento**: Unity Catalog Managed Tables — las vistas materializadas de oro se crean directamente en `oro.lab1` via LSDP. No requieren rutas de archivos.
...
|---|-----------|--------|-----------|
| I | Plataforma Exclusiva: Databricks Free Edition | PASA | Sin dependencias Azure. Solo Unity Catalog + Serverless. Las vistas materializadas residen en catalogos UC gestionados (`oro.lab1`). |
